...
from .base import BaselineRunner  # assumes base.py is in models/
from datasets import load_dataset        # or replace with local JSON loading
...
# === Configuration ===
INDEX_PATH = "C://Users//haide//UMass//Academics//Fall 2025//CS 646 - Information Retrieval//Project//barexam_qa_index"  # <-- your Pyserini index
TOP_K = 5
OUTPUT_FILE = "Experiments//bm25//barexamqa_bm25_rag_results_retrieved5.json"
